...
driver.get("https://checkvisaslots.com/latest-us-visa-availability.html?utm_source=chr_ext")
time.sleep(2)
...
time.sleep(3)
screenshot = driver.save_screenshot("/home/archaemenes/software/automation/captcha/full_screenshot.png")
...
driver.save_screenshot("/home/archaemenes/software/automation/full_page_screenshot.png")
